...
VALUES
  ('11AB1C', 'NIVM001MX2026', 'MOTF001MX26', 'Tractocamion', 'FEDERAL', '1', NULL, '1', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D01'),
  ('12CD2E', 'NIVM002MX2026', 'MOTF002MX26', 'Camion unitario', 'FEDERAL', '2', NULL, '2', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D01'),
  ('13EF3G', 'NIVM003MX2026', 'MOTF003MX26', 'Rabon', 'FEDERAL', '3', NULL, '3', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D02'),
  ('14GH4J', 'NIVM004MX2026', 'MOTF004MX26', 'Torton', 'FEDERAL', '4', NULL, '4', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D02'),
  ('15JK5L', 'NIVM005MX2026', 'MOTF005MX26', 'Tractocamion', 'FEDERAL', '5', NULL, '5', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D03'),
  ('16MN6P', 'NIVM006MX2026', 'MOTF006MX26', 'Camion unitario', 'FEDERAL', '6', NULL, '6', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D03'),
  ('17QR7S', 'NIVM007MX2026', 'MOTF007MX26', 'Rabon', 'FEDERAL', '7', NULL, '7', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D04'),
  ('18TU8V', 'NIVM008MX2026', 'MOTF008MX26', 'Torton', 'FEDERAL', '8', NULL, '8', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D04'),
  ('19WX9Y', 'NIVM009MX2026', 'MOTF009MX26', 'Tractocamion', 'FEDERAL', '9', NULL, '9', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D05'),
  ('20ZA1B', 'NIVM010MX2026', 'MOTF010MX26', 'Camion unitario', 'FEDERAL', '1', NULL, '1', true, 'SEED_REVIEW_2026_05; class=MOTOR; requires_physical=true; requires_emissions=true; owner_code=D05'),
  ...
  ('21BC2D', 'NIVA001MX2026', NULL, 'Remolque', 'FEDERAL', '2', NULL, '2', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D01'),
  ('22DE3F', 'NIVA002MX2026', NULL, 'Semirremolque', 'FEDERAL', '3', NULL, '3', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D01'),
  ('23FG4H', 'NIVA003MX2026', NULL, 'Caja seca', 'FEDERAL', '4', NULL, '4', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D02'),
  ('24HJ5K', 'NIVA004MX2026', NULL, 'Plataforma', 'FEDERAL', '5', NULL, '5', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D02'),
  ('25KL6M', 'NIVA005MX2026', NULL, 'Remolque', 'FEDERAL', '6', NULL, '6', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D03'),
  ('26NP7Q', 'NIVA006MX2026', NULL, 'Semirremolque', 'FEDERAL', '7', NULL, '7', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D03'),
  ('27RS8T', 'NIVA007MX2026', NULL, 'Caja seca', 'FEDERAL', '8', NULL, '8', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D04'),
  ('28UV9W', 'NIVA008MX2026', NULL, 'Plataforma', 'FEDERAL', '9', NULL, '9', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D04'),
  ('29XY1Z', 'NIVA009MX2026', NULL, 'Remolque', 'FEDERAL', '1', NULL, '1', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D05'),
  ('30AC2D', 'NIVA010MX2026', NULL, 'Semirremolque', 'FEDERAL', '2', NULL, '2', true, 'SEED_REVIEW_2026_05; class=ARRASTRE; requires_physical=true; requires_emissions=false; owner_code=D05'),
